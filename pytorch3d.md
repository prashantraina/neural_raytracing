...
## Neural-Raytracing extension

The extension for Neural-Raytracing uses entirely the same setup as above, and further details
can be found at the nested [readme](pytorch3d/pathtracer) in the pathtracing subdirectory.

We note that Neural-Raytracing is not affiliated with Facebook.
